                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <p>
                                        ...
                                        <a style="text-decoration: none" href="{{ $clinic->facebook }}"> {{ $clinic->name }}</a>
                                    </p>
                                    <p>
                                        <strong>instagram:</strong>
                                        <a style="text-decoration: none" href="{{ $clinic->instagram }}"> {{ $clinic->name }}</a>
                                    </p>
                                    <p>
                                        <strong>telegram:</strong>
                                        <a style="text-decoration: none" href="{{ $clinic->telegram }}"> {{ $clinic->name }}</a>
                                    </p>
                                    <a class="btn" href="{{ route('clinic.index') }}">
                                        Back to Clinics
                                    </a>
                                </tbody>
                            </table>
