            ...
            <ul class="nav flex-column">
              <li class="sidetab">
                <a href="{{ route('clinic.index') }}" class="nav-link text-white d-flex">
                  <i
                    class="fa fa-hospital-o bg-primary p-2 rounded"
          ...
          <div class="content">
            <div class="card mb-3">
              <div class="card-header">
                <a href="{{ route('clinic.create') }}" class="btn btn-primary">Add new </a>
              </div>
            </div>
            <div class="card">
              <div class="card-body">
                  ...
                  <tbody>
                    @foreach($clinics as $clinic)
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('clinic.edit', $clinic->id) }}" class="btn btn-warning">
                            Edit
                          </a>
                          
                          <form 
                            action="{{ route('clinic.destroy', $clinic->id) }}"
                            method="POST" 
